...
const enviarCorreoRestablecimiento = () => {
  ...
  firebase.auth().sendPasswordResetEmail(email)
    .then(() => {
      ...
      alert("Se ha enviado un correo electrónico de restablecimiento de contraseña a su dirección de correo electrónico.");
    })
    .catch((error) => {
      console.error("Error al enviar el correo de restablecimiento de contraseña:", error);
      alert("Ha ocurrido un error al enviar el correo de restablecimiento de contraseña. Por favor, inténtelo de nuevo más tarde.");
    });
};
const botonRestablecerContrasena = document.getElementById('contraseña');
botonRestablecerContrasena.addEventListener('click', enviarCorreoRestablecimiento);
...
btnGuardarPrincipal.addEventListener('click', function () {
  ...
  if (usuarioActual) {
    if (imagenEditada) {
      ...
      const perfilRef = storageRef.child(`perfiles/${usuarioActual.uid}/perfil.png`);
      perfilRef.put(imagenEditada).then(() => {
      ...
      console.warn("No se ha seleccionado ninguna imagen, pero se guardaron otros cambios.");
      alert("No se ha seleccionado ninguna imagen, pero se guardaron otros cambios.");
      location.reload();
    }
  } else {
